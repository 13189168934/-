    ...
    */
    ...
    function zSlider(ID, delay) {
        ...
        function autoScroll() {
            ...
            $('#picshow_img li').stop().fadeOut();
            $('#picshow_tx li').stop().fadeOut().eq(currentEQ).slideDown(400);
            $('#select_btn li').eq(currentEQ).addClass('current');
            $('#picshow_img li').eq(currentEQ).stop().fadeIn(500);
            autoScrollFUN = setTimeout(autoScroll, delay);
        }
        ...
        $('#select_btn li').click(function() {
            ...
            $('#select_btn li').removeClass('current');
            $('#picshow_img li').stop().fadeOut();
            $('#picshow_tx li').stop().fadeOut().eq(currentEQ).slideDown(100);
            $('#select_btn li').eq(currentEQ).addClass('current');
            $('#picshow_img li').eq(currentEQ).stop().fadeIn(500);
            return false;
        });
        ...
        $('#select_btn li').mouseleave(function() {
            autoScrollFUN = setTimeout(autoScroll, delay);
        })
    };
})